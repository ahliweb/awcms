...
export const DOCS_AWAITING_MIRROR = [
  ...
  ".claude/skills/awcms-abac-guard/SKILL.md",
  ".claude/skills/awcms-audit-log/SKILL.md",
  ".claude/skills/awcms-auth-online-hardening/SKILL.md",
  ".claude/skills/awcms-blog-content/SKILL.md",
  ".claude/skills/awcms-browser-test/SKILL.md",
  ".claude/skills/awcms-codeql-triage/SKILL.md",
  ".claude/skills/awcms-comments/SKILL.md",
  ".claude/skills/awcms-data-lifecycle/SKILL.md",
  ".claude/skills/awcms-deploy/SKILL.md",
  ".claude/skills/awcms-document-infrastructure/SKILL.md",
  ".claude/skills/awcms-edge-cache/SKILL.md",
  ".claude/skills/awcms-email/SKILL.md",
  ".claude/skills/awcms-erp-extension-readiness/SKILL.md",
  ".claude/skills/awcms-form-drafts/SKILL.md",
  ".claude/skills/awcms-github-snapshot/SKILL.md",
  ".claude/skills/awcms-i18n/SKILL.md",
  ".claude/skills/awcms-idempotency/SKILL.md",
  ".claude/skills/awcms-idn-admin-regions/SKILL.md",
  ".claude/skills/awcms-implement-issue/SKILL.md",
  ".claude/skills/awcms-integration-hub/SKILL.md",
  ".claude/skills/awcms-integration/SKILL.md",
  ".claude/skills/awcms-jualanku-porting/SKILL.md",
  ".claude/skills/awcms-legacy-migration/SKILL.md",
  ".claude/skills/awcms-media-library/SKILL.md",
  ".claude/skills/awcms-module-management/SKILL.md",
  ".claude/skills/awcms-new-endpoint/SKILL.md",
  ".claude/skills/awcms-new-event/SKILL.md",
  ".claude/skills/awcms-new-migration/SKILL.md",
  ".claude/skills/awcms-new-module/SKILL.md",
  ".claude/skills/awcms-news-portal/SKILL.md",
  ".claude/skills/awcms-observability/SKILL.md",
  ".claude/skills/awcms-performance/SKILL.md",
  ".claude/skills/awcms-port-from-mini/SKILL.md",
  ".claude/skills/awcms-pr-review/SKILL.md",
  ".claude/skills/awcms-production-preflight/SKILL.md",
  ".claude/skills/awcms-profile-identity/SKILL.md",
  ".claude/skills/awcms-release/SKILL.md",
  ".claude/skills/awcms-repo-inventory/SKILL.md",
  ".claude/skills/awcms-reporting/SKILL.md",
  ".claude/skills/awcms-security-hardening/SKILL.md",
  ".claude/skills/awcms-security-review/SKILL.md",
  ".claude/skills/awcms-sensitive-data/SKILL.md",
  ".claude/skills/awcms-seo-distribution/SKILL.md",
  ".claude/skills/awcms-site-search/SKILL.md",
  ".claude/skills/awcms-social-publishing/SKILL.md",
  ".claude/skills/awcms-sync-hmac/SKILL.md",
  ".claude/skills/awcms-tenant-admin/SKILL.md",
  ".claude/skills/awcms-tenant-domain-routing/SKILL.md",
  ".claude/skills/awcms-testing/SKILL.md",
  ".claude/skills/awcms-theming/SKILL.md",
  ".claude/skills/awcms-ui-screen/SKILL.md",
  ".claude/skills/awcms-ux-review/SKILL.md",
  ".claude/skills/awcms-visitor-analytics/SKILL.md",
  ".claude/skills/awcms-wizard-form/SKILL.md",
  ".claude/skills/awcms-workflow-approval/SKILL.md",
