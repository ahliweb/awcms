...
/**
 * Builds a public URL from a canonical R2 object key (spec §13.1).
 * Use for all new uploads that follow the canonical key format from
 * `generateObjectKey()` in `src/lib/storage/objectKeys.js`.
 *
 * @param {string} canonicalObjectKey - Generated by generateObjectKey()
 * @returns {string} Full public Edge API URL
 */
export const buildCanonicalMediaUrl = (canonicalObjectKey) => {
  return buildMediaPublicUrl(canonicalObjectKey);
};
