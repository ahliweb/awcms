...
| Admin screens                     | **58** `.astro` files in `src/pages/admin/`; **0 of 25** modules without `navigation:` | `find src/pages/admin -name '*.astro'`, `grep -L 'navigation:' src/modules/*/module.ts` |
| `.astro` files                    | **72** (40.292 lines) — on typechecking see §6                                         | `find src -name '*.astro'`                                                              |
