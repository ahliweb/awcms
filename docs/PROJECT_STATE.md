...
| Admin screens                     | **57** `.astro` files in `src/pages/admin/`; **0 of 25** modules without `navigation:` | `find src/pages/admin -name '*.astro'`, `grep -L 'navigation:' src/modules/*/module.ts` |
| `.astro` files                    | **71** (39.738 lines) — on typechecking see §6                                         | `find src -name '*.astro'`                                                              |
