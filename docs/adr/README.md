...
<!-- i18n-source-hash: sha256:56730904bf63568e889fab61035104d6dabea7e0bd09657d99c27aa3c45b59f7 -->

# Architecture Decision Records (ADR)

This folder holds AWCMS's **architectural decision records** — one of the **three AWCMS-family templates used directly** (the ERP/back-office lineage; see [ADR-0034](0034-awcms-family-direct-use-templates-and-derived-pathway-removal.md)). Every significant decision (architecture, runtime, contracts, security, or a deviation from the baseline standard) is recorded as one ADR file so the context and reasoning survive.
