...
Folder ini menyimpan **catatan keputusan arsitektural** AWCMS — salah satu dari **tiga template keluarga AWCMS yang dipakai langsung** (lini ERP/back-office; lihat [ADR-0034](0034-awcms-family-direct-use-templates-and-derived-pathway-removal.md)). Setiap keputusan penting (arsitektur, runtime, kontrak, keamanan, atau penyimpangan dari standar dasar) dicatat sebagai satu berkas ADR agar konteks dan alasannya awet.
