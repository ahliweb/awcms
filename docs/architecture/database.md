...
> **2026-03-29 Baseline:** Migration inventory shows `152` root migrations and `152` mirrored migrations. Re-run `scripts/verify_supabase_migration_consistency.sh` for filename/content parity before relying on counts alone.
