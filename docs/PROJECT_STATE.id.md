...
<!-- i18n-source-hash: sha256:e39c361bcb9c8da5f4836e326a5fe6813ecf6d48de91861a221093377b4a914d -->
...
| Migrasi                            | **151** (`sql/001`–`151`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **63** (36.365 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
