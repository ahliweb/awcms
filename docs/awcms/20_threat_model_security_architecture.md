...
| Unbounded/abusive request volume against an unauthenticated surface                                      | Bounded request bodies (`readCappedText`, the same streaming size cap `readJsonBody` uses) and per-(tenant, worker) rate limiting (`checkSharedRateLimit`) on every one of the four routes.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
