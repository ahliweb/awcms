...
<!-- i18n-source-hash: sha256:62bc47bc068fce7e3e61133f6baeb6a22234cee255c05a017b37e32b57503fca -->
...
| Volume request tak terbatas/abusif terhadap permukaan tak terautentikasi                                   | Body request dibatasi (`readCappedText`, batas ukuran streaming sama yang dipakai `readJsonBody`) dan rate limiting per-(tenant, worker) (`checkSharedRateLimit`) pada keempat rute.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
