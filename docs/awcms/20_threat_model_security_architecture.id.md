...
<!-- i18n-source-hash: sha256:429667f41c8374c3dac453a41db3baded6b054dc3d8af98f30facca13c903ba2 -->
...
| Referensi lintas-tenant lewat tabel nonce/results                                                          | FK komposit `(tenant_id, worker_id)` / `(tenant_id, idempotency_key)` (pemeriksaan RI berjalan melewati RLS — GHSA-r7cx-c4jh-cvvw), bukan FK kolom tunggal biasa, ditambah RLS `FORCE` pada kedua tabel baru.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
