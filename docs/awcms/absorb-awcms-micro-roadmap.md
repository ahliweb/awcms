...
| 0         | Seam kontribusi `ModuleDescriptor`                                                                                                                                                                    | 🟡 sebagian (`dataLifecycle` #222, capability `seo_facts` #223, `searchSources` #231 sudah; `commentableResources`/`newsletterContentSources` belum) | #222/#223/#231 |
