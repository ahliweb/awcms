...
| 0         | Seam kontribusi `ModuleDescriptor`                                                                                                                                                                    | 🟡 sebagian (`dataLifecycle` #222, capability `seo_facts` #223, `searchSources` #231, `commentableResources` in-flight `feat/port-comments` sudah; `newsletterContentSources` belum)   | #222/#223/#231 |
...
| 1         | `comments`                                                                                                                                                                                            | 🟡 sedang berjalan (branch `feat/port-comments`: seam `commentableResources` + `MODULE_CONTRACT_VERSION` 2.3.0, `sql/066`–`067`, spine sanitasi; modul belum terdaftar)                | —              |
| 1         | `newsletter`                                                                                                                                                                                          | ⏳ belum                                                                                                                                                                               | —              |
