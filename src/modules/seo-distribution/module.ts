 ...
 * policy-gated legacy `/blog/{tenantCode}` → `/news` auto-redirect (LIVE since
 * ADR-0059 landed the `/news/**` family; off by default, and enabling it is a
 * one-way content-URL migration because a 301 is cached); audited URL-change capture; bounded non-recursive
