-- Seed missing canonical tenant.policy.* management permissions.

WITH permission_seed(name, resource, action, description) AS (
  VALUES
    ('tenant.policy.create', 'policies', 'create', 'Create policies'),
    ('tenant.policy.update', 'policies', 'update', 'Update policies'),
    ('tenant.policy.delete', 'policies', 'delete', 'Delete policies')
